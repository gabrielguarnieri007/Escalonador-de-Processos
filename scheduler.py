...
class Scheduler:
    """Gerencia as filas de processos e implementa a lógica de escalonamento."""
    def __init__(self):
    ...
    def adicionar_processo(self, processo: Processo):
        """Adiciona um processo à sua fila de prioridade correspondente."""
    ...
    def imprimir_estado_geral(self):
        """Imprime o estado atual de todas as filas e contadores."""
    ...
    def tem_processos_pendentes(self):
        """Verifica se ainda existem processos em qualquer uma das filas."""
    ...
    def executarCicloDeCPU(self):
        """Executa um único ciclo de CPU, aplicando todas as regras de escalonamento."""
        
        # REGRA 1: DESBLOQUEIO DE PROCESSOS
        ...
        # REGRA 2: ESCOLHA DO PROCESSO PARA EXECUTAR
        ...
        # REGRA 3: PROCESSAR O PROCESSO ESCOLHIDO
        if processo_a_executar:
